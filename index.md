...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/hiv/ImplementationGuide/zw.fhir.ig.hiv | *Version*:0.1.0 |
| Draft as of 2025-11-13 | *Computable Name*:HIV |
...
* Creating an issue on GitHub [hiv repository](https://github.com/WorldHealthOrganization/hiv)
...
This is an R4 IG. None of the features it uses are changed in R4B, so it can be used as is with R4B systems. Packages for both [R4 (zw.fhir.ig.hiv.r4)](package.r4.tgz) and [R4B (zw.fhir.ig.hiv.r4b)](package.r4b.tgz) are available.
...
```json
{
  ...
  "id" : "zw.fhir.ig.hiv",
  "url" : "http://mohcc.gov.zw/fhir/hiv/ImplementationGuide/zw.fhir.ig.hiv",
  "version" : "0.1.0",
  "name" : "HIV",
  "title" : "HIV",
  "status" : "draft",
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://mohcc.gov.zw/fhir/hiv/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
